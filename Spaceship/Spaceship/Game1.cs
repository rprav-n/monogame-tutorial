...
public class Game1 : Game
{
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        for (int i = 0; i < gameController.asteroids.Count; i++)
        {
            ...
            if (Vector2.Distance(gameController.asteroids[i].position, new Vector2(player.position.X - 34, player.position.Y - 50)) < sum)
            {
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        for (int i = 0; i < gameController.asteroids.Count; i++)
        {
            ...
            _spriteBatch.Draw(asteroidSprite, new Vector2(asteroid.position.X - asteroid.radius,
                asteroid.position.Y - asteroid.radius), Color.White);
        }
        ...
        _spriteBatch.DrawString(timerFont, "Time: " + Math.Floor(gameController.totalTime).ToString(), new Vector2(10, 10), Color.White);
